...
#. Find a ``FLIM-modulo-sample.ome.tiff`` image (either it was pre-imported for you under ``FLIM`` Project or Dataset or import it from `here <http://www.openmicroscopy.org/Schemas/Samples/2013-06/FLIM-modulo-sample.ome.tiff>`_ 
