...
#. In Importer, in the Location dialog. Switch from Project/Dataset to Screen. Import a plate with multiple fields for example ``ome/data_repo/curated/hms/cellworx/plate1/plate1_B02.pnl``. Other useful plate can be found [:download:`here </downloads/ImportTestingSetTable.pdf>`].
