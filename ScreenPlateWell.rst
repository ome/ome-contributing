...
#. In Importer, in the Location dialog. Switch from Project/Dataset to Screen. Import a plate with multiple fields for example ``ome/data_repo/test_images_good/cellworx/hms/plate1/plate1_802.pnl``. Other useful plate can be found [:download:`here </downloads/ImportTestingSetTable.pdf>`].
