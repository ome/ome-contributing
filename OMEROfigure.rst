...
#. Test units display & conversion. You need an image that has different units for pixel size. See https://docs.openmicroscopy.org/latest/omero/developers/Python.html#create-image and look for "Set the pixel size using units" for how to edit this.
